...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("pkill -x waypaper || waypaper")) -- wallpaper picker (toggle)
...
-- Move windows with mainMod + SHIFT + arrow keys (swaps position in tiling, moves when floating)
...
-- Next/previous workspace (keyboard three-finger-swipe equivalent)
